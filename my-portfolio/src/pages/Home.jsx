  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="max-w-[1550px] mx-auto">
        {/* Header row */}
        <motion.div 
          className="flex flex-col sm:flex-row justify-between items-center pt-16 sm:pt-32 pb-6 sm:pb-10 px-4 sm:px-12"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          <p className="text-[#888] text-2xl sm:text-3xl hover:text-white transition-colors duration-300 mb-4 sm:mb-0">Hi, I'm Tarun</p>
          <div className="flex items-center gap-2 group cursor-pointer">
            <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
            <p className="text-[#888] text-base sm:text-xl group-hover:text-white transition-colors duration-300">
        ...
        >
          <div className="max-w-5xl">
            <h1 className="text-4xl sm:text-6xl lg:text-8xl font-light tracking-tight leading-[1.1] mb-8 sm:mb-16">
            ...
            <motion.p 
              className="text-[#888] text-lg sm:text-xl lg:text-2xl font-light leading-relaxed max-w-3xl hover:text-[#999] transition-colors duration-300"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      {/* Skills Section */}
      <motion.section 
        className="max-w-[1400px] mx-auto px-4 sm:px-12 py-16 sm:py-32 relative"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
      >
        <motion.h2 
          className="text-3xl sm:text-4xl lg:text-5xl font-light mb-12 sm:mb-24 text-center bg-clip-text bg-gradient-to-r from-beige to-gray-400"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
      ...
      <motion.section 
        id="projects" 
        className="max-w-[1400px] mx-auto px-4 sm:px-12 py-16 sm:py-32"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
      >
        ...
        <div className="space-y-20 sm:space-y-40">
          {projects.map((proj, i) => (
            ...
            >
              <motion.div
                className="relative bg-white/5 backdrop-blur-sm rounded-xl p-6 sm:p-8 border border-white/10 group hover:border-white/30 transition-all duration-300 w-full md:w-auto"
                whileHover={{ scale: 1.02 }}
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
              >
                <h3 className="text-2xl sm:text-3xl font-light mb-3 sm:mb-4 text-white/90">{proj.title}</h3>
                <p className="text-base sm:text-lg text-gray-400 mb-4 sm:mb-6">{proj.description}</p>
                <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6">
                  {proj.tech.map((tech, index) => (
                    <span 
                      key={index}
                      className="px-2 sm:px-3 py-1 bg-white/10 rounded-full text-xs sm:text-sm text-white/70"
                    >
                      {tech}
                    </span>
                  ))}
